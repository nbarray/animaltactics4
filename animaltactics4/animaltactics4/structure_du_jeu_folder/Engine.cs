...
namespace animaltactics4
{
    ...
    static class Engine
    {
        ...
        static public void Draw()
        {
            ...
            Contents.DrawString(Serveur.Etape1_connection_du_client.ToString() + " : Connection du client", new Rectangle(0, 0, 100, 50));
            Contents.DrawString(Serveur.Etape2_synchronisation_des_joueurs.ToString() + " : Syncho des joueurs", new Rectangle(0, 100, 100, 50));
            Contents.DrawString(Serveur.Etape3_partie_en_cours.ToString() + " : Partie en cours", new Rectangle(0, 200, 100, 50));
