...
namespace animaltactics4
{
    static class Contents
    {
        ...
        static public void LoadContent(ContentManager content_)
        {
            ...
            textures.Add(Divers.getName(e_classe.PandawanMoine), content_.Load<Texture2D>("Image\\Unite\\PandaMoineErrant"));
            textures.Add(Divers.getName(e_classe.PandawanYabusame), content_.Load<Texture2D>("Image\\Unite\\PandaSamouraiArcher"));
            textures.Add(Divers.getName(e_classe.PandawanBushi), content_.Load<Texture2D>("Image\\Unite\\PandaSamourai"));
            textures.Add(Divers.getName(e_classe.PandawanCharDragon), content_.Load<Texture2D>("Image\\Unite\\PandaTank"));
            textures.Add(Divers.getName(e_classe.PandawanMerco), content_.Load<Texture2D>("Image\\Unite\\PandaMercenaire"));
            textures.Add(Divers.getName(e_classe.PandawanSokei), content_.Load<Texture2D>("Image\\Unite\\PandaLancier"));
            textures.Add(Divers.getName(e_classe.PandawanNinja), content_.Load<Texture2D>("Image\\Unite\\PandaNinja"));
            textures.Add(Divers.getName(e_classe.PandawanSniper), content_.Load<Texture2D>("Image\\Unite\\PandaSniper"));
            textures.Add(Divers.getName(e_classe.PandawanSayan), content_.Load<Texture2D>("Image\\Unite\\PandaSayen"));
            ...
            textures.Add(Divers.getName(e_classe.FenrirWarlord), content_.Load<Texture2D>("Image\\Unite\\FenrirWarlord"));
            textures.Add(Divers.getName(e_classe.FenrirOkami), content_.Load<Texture2D>("Image\\Unite\\FenrirOkami"));
            textures.Add(Divers.getName(e_classe.KrissaChef), content_.Load<Texture2D>("Image\\Unite\\KrissaChef"));
            textures.Add(Divers.getName(e_classe.KrissaAssassin), content_.Load<Texture2D>("Image\\Unite\\KrissaAssassin"));
            textures.Add(Divers.getName(e_classe.KrissaLegionnaire), content_.Load<Texture2D>("Image\\Unite\\KrissaLegionnaire"));
